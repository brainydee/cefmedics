...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="{{ app()->environment('production') ? asset('public/assets/vendor/owl.carousel/assets/owl.theme.default.min.css') : asset('assets/vendor/owl.carousel/assets/owl.theme.default.min.css') }}">
										...
										<nav class="header-nav-top">
											<ul class="nav nav-pills">
												<li class="nav-item nav-item-borders py-2 d-none d-sm-inline-flex">
													<span class="ps-0"><i class="far fa-dot-circle text-4 text-color-primary" style="top: 1px;"></i> 12B Vincent Eze Street, Ajao Estate, Isolo, Lagos</span>
												</li>
						...
						<div class="col-md-4 col-lg-3">
							<div class="contact-details">
								...
								<a class="text-decoration-none" href="tel:1234567890">
									<strong class="font-weight-light">+2348035858071</strong>
								</a>
							</div>
						</div>
