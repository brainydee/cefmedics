            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 order-2 order-md-1 align-self-center p-static">
                        ...
                        <span class="sub-title">Our Doctors are available on Friday 2pm - 8pm, Saturdays 2pm - 8pm and Sunday 7pm to 10pm </span>
                    </div>
                    ...
                    <form wire:submit.prevent = "save">
                        ...
                        <div class="row">
                            <div class="form-group col">
                                ...
                                <input type="file" wire:model = "file" value="" data-msg-required="Please enter the subject." maxlength="100" class="form-control text-3 h-auto py-2" name="file">
