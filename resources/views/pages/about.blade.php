...
<div role="main" class="main">
        ...
        <div class="row mt-5">
            ...
            <div class="col-lg-4">
                ...
                <div class="owl-carousel owl-theme dots-inside mt-2" data-plugin-options="{'items': 1, 'margin': 10, 'animateOut': 'fadeOut', 'autoplay': true, 'autoplayTimeout': 3000}">
                    <div>
                        <img src="{{asset('assets/img/gallery/slide1.jpg')}}" alt="" class="img-fluid box-shadow-custom" />
                    </div>
                    <div>
                        <img src="{{asset('assets/img/gallery/slide2.jpg')}}" alt="" class="img-fluid box-shadow-custom" />
                    </div>
                </div>
    ...
    <section class="call-to-action call-to-action-default call-to-action-big content-align-center mb-0 mt-3 text-center">
