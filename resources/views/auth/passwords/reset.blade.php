                    ...
                    @csrf
                        ...
                        <div class="row">
                            <div class="form-group col">
                                ...
                                <input  id="password" type="password" value="" class="form-control form-control-lg text-4 @error('password') is-invalid @enderror" name = "password"  required " autofocus>
                                @error('password')
                                    <span class="text-danger" style="color:red;" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row">
                            <div class="form-group col">
                                ...
                                <input  id="password-confirm" type="password" value="" class="form-control form-control-lg text-4 @error('password') is-invalid @enderror" name="password_confirmation" required autocomplete="new-password">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col">
                                <button type="submit" class="btn btn-dark btn-modern w-100 text-uppercase rounded-0 font-weight-bold text-3 py-3" data-loading-text="Loading..."><i class="fas fa-sign-in-alt"></i>&nbsp;&nbsp;Rest Password</button>
                            </div>
                        </div>
                    </form>
                </div>
